...
export const auth = <ThrowOnError extends boolean = false>(options?: Options<AuthData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<AuthResponse, AuthError2, ThrowOnError>({
        security: [
            {
                name: 'X-API-Key',
                type: 'apiKey'
